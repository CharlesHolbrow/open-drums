...
exports.brightPad = exports.sineSlowDecay = exports.sine = void 0;
const podolski_vst2_1 = require("./podolski-vst2");
/** Almost pure sine tone with a very short attack and release */
function sine() {
    return new podolski_vst2_1.PodolskiVst2({
        ...
        vccMode: podolski_vst2_1.PodolskiVst2.parameterLibrary.vccMode.choices.poly,
...
exports.sineSlowDecay = sineSlowDecay;
/**
...
function brightPad() {
    return new podolski_vst2_1.PodolskiVst2({
        ...
        osc1PhaseModDepth: 0,
        osc1PhaseModSrc: podolski_vst2_1.PodolskiVst2.parameterLibrary.osc1PhaseModSrc.choices.lfoglobal,
        vca1ModDepthPercent: 60,
        osc1Tune: 12,
        osc1InverseVolumePercent: 60,
        osc1WarpModSrc: podolski_vst2_1.PodolskiVst2.parameterLibrary.osc1WarpModSrc.choices.keyfollow,
        osc1WarpModDepthPercent: 47,
        // Filter
        vcf0Cutoff: 28,
        vcf0ResonancePercent: 6,
        vcf0KeyFollowPercent: 100,
        vcf0Modsource1: podolski_vst2_1.PodolskiVst2.parameterLibrary.vcf0Modsource1.choices.velocity,
        vcf0CutoffMod1: 15,
        vcf0Modsource2: podolski_vst2_1.PodolskiVst2.parameterLibrary.vcf0Modsource2.choices.envelope1,
        vcf0CutoffMod2: 48,
        vcf0DrivePercent: 40,
        vcf0ClickPercent: 18,
        // LFO1
        lfo1Sync: 0.346,
        lfo1Waveform: podolski_vst2_1.PodolskiVst2.parameterLibrary.lfo1Waveform.choices.sine,
        lfo1Restart: podolski_vst2_1.PodolskiVst2.parameterLibrary.lfo1Restart.choices.sync,
        lfo1DelayPercent: 25,
        lfo1DepthModDpt1Percent: 0,
        // Global LFO
        lfogSync: .308,
        lfogWaveform: podolski_vst2_1.PodolskiVst2.parameterLibrary.lfogWaveform.choices.sine,
        // Chorus
        ...
        chrsMixPercent: 32,
        // Delay
        dly1SyncLeft: podolski_vst2_1.PodolskiVst2.parameterLibrary.dly1SyncLeft.choices['1/4'],
        dly1SyncRight: podolski_vst2_1.PodolskiVst2.parameterLibrary.dly1SyncRight.choices['1/8 dot'],
...
exports.brightPad = brightPad;
//# sourceMappingURL=podolski-vst2-presets.js.map
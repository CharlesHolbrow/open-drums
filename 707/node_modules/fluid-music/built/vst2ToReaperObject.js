...
exports.vst2ToReaperObject = void 0;
 ...
 * @returns {ReaperVst}
 */
function vst2ToReaperObject(client, trackName, plugin, n, bpm) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const pluginReport = yield cybr.requests.requestReport(pluginName, cybrType, trackName, n, paramSetters, client);
        ...
        for (const [paramKey, automation] of Object.entries(plugin.automation)) {
            ...
            for (const autoPoint of automation.points) {
                if (typeof autoPoint.value === 'number') {
                    ...
                    const normalizedValue = plugin.getNormalizedValue(paramKey, explicitValue);
                    if (typeof normalizedValue === 'number') {
                        automationTrack.addBezierPoint(autoPoint.startTime * 4 * 60 / bpm, normalizedValue, autoPoint.curve);
                    }
                    else {
...
exports.vst2ToReaperObject = vst2ToReaperObject;
//# sourceMappingURL=vst2ToReaperObject.js.map
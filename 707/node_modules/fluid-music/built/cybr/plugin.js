...
exports.getSingleParamReport = exports.getParamReport = exports.getReport = exports.loadTrkpreset = exports.load = exports.save = exports.setSidechainInput = exports.setExternalParamHelper = exports.setParamExplicitAt = exports.setParamNormalizedAt = exports.setParamExplicit = exports.setParamNormalized = exports.select = void 0;
const fs = require('fs');
/**
 ...
 *    track.
 */
function select(pluginName, pluginType, pluginId = 0) {
 ...
 */
function setParamNormalized(paramName, normalizedValue) {
...
exports.setParamNormalized = setParamNormalized;
/**
 ...
 */
function setParamExplicit(paramName, paramValue) {
    if (typeof paramName !== 'string')
        throw new Error('plugin.setParam needs a parameterName, got: ' + paramName);
...
exports.setParamExplicit = setParamExplicit;
/**
 ...
 */
function setParamNormalizedAt(paramName, normalizedValue, timeInWholeNotes = 0, curve = 0) {
    if (typeof paramName !== 'string')
        throw new Error('plugin.setParam needs a parameterName, got: ' + paramName);
    if (typeof normalizedValue !== 'number')
        throw new Error('plugin.setParam needs a value number, got ' + normalizedValue);
...
exports.setParamNormalizedAt = setParamNormalizedAt;
/**
 * Changes the automation curve of the parameter value, adds a point to the
 ...
 *    quickly, and decelerates.
 */
function setParamExplicitAt(paramName, paramValue, timeInWholeNotes = 0, curve = 0) {
    if (typeof paramName !== 'string')
        throw new Error('plugin.setParam needs a parameterName, got: ' + paramName);
    if (typeof paramValue !== 'number')
        throw new Error('plugin.setParam needs a value number, got ' + paramValue);
...
exports.setParamExplicitAt = setParamExplicitAt;
/**
 ...
 *    quickly, and decelerates.
 */
function setExternalParamHelper(paramName, paramValue, timeInWholeNotes, curve) {
...
exports.setExternalParamHelper = setExternalParamHelper;
/**
 ...
 *    not exist.
 */
function setSidechainInput(inputTrackName) {
...
exports.setSidechainInput = setSidechainInput;
/**
...
function loadTrkpreset(file) {
    ...
    if (typeof file === 'string') {
        ...
        if (!buffer)
            throw new Error('plugin.loadTrkpreset failed to load file: ' + file);
    }
...
exports.loadTrkpreset = loadTrkpreset;
/**
 ...
 **/
function getReport() { return { address: '/plugin/report' }; }
 ...
 * ```
 */
function getParamReport(steps = 0) {
...
exports.getParamReport = getParamReport;
function getSingleParamReport(paramName, steps = 0) {
    if (typeof paramName !== 'string')
...
exports.getSingleParamReport = getSingleParamReport;

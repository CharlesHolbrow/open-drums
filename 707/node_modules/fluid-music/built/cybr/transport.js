...
exports.to = exports.loop = exports.stop = exports.play = void 0;
/**
 * Begin playback
 */
function play() { return { address: '/transport/play' }; }
exports.play = play;
/**
* Stop playback
*/
function stop() { return { address: '/transport/stop' }; }
exports.stop = stop;
/**
 ...
 */
function loop(startTimeInWholeNotes, durationInWholeNotes) {

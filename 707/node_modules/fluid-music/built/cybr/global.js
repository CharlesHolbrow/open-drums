...
exports.activate = exports.cd = exports.save = void 0;
/**
 ...
 */
function save(filename, samplePathMode) {
    ...
    if (samplePathMode)
        args.push({ type: 'string', value: samplePathMode });
 ...
 */
function activate(filename, forceEmptyEdit) {

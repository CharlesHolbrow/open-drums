...
exports.setSourceOffsetSeconds = exports.trimSeconds = exports.length = exports.select = exports.render = void 0;
/**
 ...
 */
function render(filename, tailInSeconds) {
 ...
 */
function length(durationInWholeNotes, trimStart = false) {
 ...
 */
function trimSeconds(secondsToStart = 0, secondsFromEnd = 0) {
    if (!secondsToStart)
        secondsToStart = 0;
 ...
 */
function setSourceOffsetSeconds(startAtSeconds) {
...
exports.setSourceOffsetSeconds = setSourceOffsetSeconds;

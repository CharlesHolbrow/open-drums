...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c4 = function(token, params) { return { token, params }; },
      peg$c5 = peg$otherExpectation("token"),
      peg$c6 = /^[A-Z_0-9]/,
      peg$c7 = peg$classExpectation([["A", "Z"], "_", ["0", "9"]], false, false),
      peg$c8 = function(chars) { return chars.join(''); },
      peg$c9 = "VST",
      peg$c10 = peg$literalExpectation("VST", false),
      peg$c11 = function(params, vstA, vstB, vstC) { 
        const b64Chunks = [vstA, vstB, vstC]
        return new ReaperBase({ token: "VST", params, b64Chunks });
      },
      peg$c12 = "NOTES",
      peg$c13 = peg$literalExpectation("NOTES", false),
      peg$c14 = function(note) { 
        return new ReaperBase({ token: "NOTES", params: [ note ]}); 
      },
      peg$c15 = function(token, params, b64Chunks) {
        return new ReaperBase({ token, params, b64Chunks })
      },
      peg$c16 = "RECORD_CFG",
      peg$c17 = peg$literalExpectation("RECORD_CFG", false),
      peg$c18 = "APPLYFX_CFG",
      peg$c19 = peg$literalExpectation("APPLYFX_CFG", false),
      peg$c20 = "RENDER_CFG",
      peg$c21 = peg$literalExpectation("RENDER_CFG", false),
      peg$c22 = peg$otherExpectation("param"),
      peg$c23 = function(p) { return p[0]; },
      peg$c24 = peg$otherExpectation("params"),
      peg$c25 = function(line) {return line},
      peg$c26 = function(lines) { return lines },
      ...
      peg$c34 = function(lines) { return lines.join('\n'); },
      peg$c35 = "|",
      ...
      peg$c42 = /^[a-z 0-9!.,:@#$%\^&*(){}<>_+\/="'|`\-]/i,
      peg$c43 = peg$classExpectation([["a", "z"], " ", ["0", "9"], "!", ".", ",", ":", "@", "#", "$", "%", "^", "&", "*", "(", ")", "{", "}", "<", ">", "_", "+", "/", "=", "\"", "'", "|", "`", "-"], false, true),
      peg$c44 = ".",
      peg$c45 = peg$literalExpectation(".", false),
      peg$c46 = function(txt) { return parseFloat(txt); },
      peg$c47 = "0",
      ...
      peg$c53 = function(txt) { return parseInt(txt); },
      peg$c54 = /^[0-9]/,
      ...
      peg$c66 = function(fullLines, lastLine) {
        return fullLines.join('') + lastLine
      },
      peg$c67 = function(line) { // every b64 chunk ends with a short line
        return line.length < 128
      },
      peg$c68 = function(line) { return line },
      peg$c69 = function(line) {
        return line.length >= 128
      },
      peg$c70 = "=",
      peg$c71 = peg$literalExpectation("=", false),
      peg$c72 = function(chars, e1, e2) {
